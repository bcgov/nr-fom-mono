...
export const APIS = [AttachmentService, AuthService, DistrictService, ForestClientService, InteractionService, ProjectService, PublicCommentService, PublicNoticeService, SpatialFeatureService, SubmissionService];
