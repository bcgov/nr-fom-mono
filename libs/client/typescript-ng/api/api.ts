...
export const APIS = [AttachmentService, AttachmentTypeCodeService, CommentScopeCodeService, DistrictService, ForestClientService, InteractionService, ProjectService, ProjectsService, PublicCommentService, ResponseCodeService, SubmissionService, SubmissionTypeCodeService, WorkflowStateCodeService];
